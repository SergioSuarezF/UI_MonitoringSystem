                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 32.0),
                                            child: Text(
                                              'Sistema de monitoreo de movimientos',
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 0.0, 24.0, 0.0),
                                            child: Image.asset(
                                              'assets/images/Nio_Webp_sinfondo.png',
                                              height: 250.0,
                                              fit: BoxFit.fill,
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Monitorea y evalúa las actividades físicas de tus estudiantes',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Clasfica a tus estudiantes en base a su rendimiento: alto, moderado o bajo',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.asset(
                                                'assets/images/DALLE_2024-11-15_19.01.34_-_A_conceptual_and_modern_black-and-white_illustration_representing_computer_vision._The_image_should_include_elements_such_as_a_digital_eye_or_camera_l.png',
                                                height: 250.0,
                                                fit: BoxFit.contain,
                                              ),
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Adapta tus actividades físicas en base a las necesidades específicas de cada niño',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
