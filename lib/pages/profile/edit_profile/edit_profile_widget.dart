                ...
                children: [
                  ...
                  wrapWithModel(
                    ...
                    child: TitleWithSubtitleWidget(
                      ...
                      subtitle:
                          'Recibirás un link en tu correo para cambiar tu contraseña',
                    ),
                  ),
                  Padding(
                    padding:
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDIT_PROFILE_CAMBIAR_CONTRASEA_BTN_ON_TA');
                  ...
                  wrapWithModel(
                    ...
                    child: TitleWithSubtitleWidget(
                      title: 'Borrar cuenta',
                      subtitle:
                          'Toda la información de tu cuenta será eliminada',
                    ),
                  ),
                  Padding(
                    padding:
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDIT_PROFILE_BORRAR_CUENTA_BTN_ON_TAP');
                        logFirebaseEvent('Button_auth');
